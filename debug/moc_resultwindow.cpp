...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_resultWindow_t, stringdata0) + ofs), len 
...
const QMetaObject resultWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_resultWindow.offsetsAndSize,
    qt_meta_data_resultWindow,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_resultWindow_t
